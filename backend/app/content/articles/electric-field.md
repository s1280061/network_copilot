...
クーロン力 \( F \) [N]。クーロン定数 \( k = 9.0\times10^9 \) [N·m²/C²]、電荷 \( q_1, q_2 \) [C]、距離 \( r \) [m]。同符号なら斥力、異符号なら引力で、距離の2乗に反比例します。
...
電場 \( E \) [V/m または N/C] は単位電荷あたりに働く力。点電荷 \( Q \) [C] から距離 \( r \) [m] の点で、クーロン力と同じく距離の2乗に反比例します。
...
電位 \( V \) [V] は電場を距離に沿って積分した量。点電荷 \( Q \) [C] からの電位は距離 \( r \) [m] に反比例し（\( \propto 1/r \)）、電場（\( \propto 1/r^2 \)）よりゆるやかに減衰します。
...
一様な電場 \( E \) [V/m] は、電圧 \( V \) [V] を電極間距離（膜厚）\( d \) [m] で割った値。これが材料の絶縁破壊電界を超えると放電・絶縁破壊が起こります。
...
帯電体（コンデンサ）に蓄えられる静電エネルギー \( E \) [J]。静電容量 \( C \) [F] と電圧 \( V \) [V] で決まり、電圧の2乗に比例するため高電圧の帯電は大きなエネルギーを持ちます。
