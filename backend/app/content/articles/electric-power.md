...
電力 \( P \) [W] は電圧 \( V \) [V] と電流 \( I \) [A] の積。オームの法則 \( V=RI \) を代入すると、抵抗 \( R \) [Ω] を使った3通りの等価な式になります。
...
電力量 \( W \) は電力 \( P \) [W] と時間 \( t \) の積。時間を [h] で取れば [Wh]、1000で割れば [kWh] になります。
...
ジュール熱 \( Q \) [J] は、抵抗 \( R \) [Ω] を電流 \( I \) [A] が時間 \( t \) [s] 流れたときに発生する熱エネルギー。消費電力 \( P=I^2R \) に時間を掛けた量に等しくなります。
